/**
 * postinstall: copy skidi's wasm binaries to public/ so Vite's dev server and
 ...
 * reference wasm via `new URL('../node_modules/skidi/dist/simd.wasm', import.meta.url)`
...
const skidiDist = join(__dir, '..', 'node_modules', 'skidi', 'dist');
