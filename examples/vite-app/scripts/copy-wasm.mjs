/**
 * postinstall: copy wispdf's wasm binaries to public/ so Vite's dev server and
 ...
 * reference wasm via `new URL('../node_modules/wispdf/dist/simd.wasm', import.meta.url)`
...
const wispdfDist = join(__dir, '..', 'node_modules', 'wispdf', 'dist');
